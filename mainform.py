...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEditUrl.setGeometry(QtCore.QRect(520, 50, 191, 31))
        ...
        self.textEditPath = QtWidgets.QTextEdit(self.centralwidget)
        self.textEditPath.setGeometry(QtCore.QRect(300, 50, 191, 31))
