...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBoxStyle.setGeometry(QtCore.QRect(290, 90, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.comboBoxStyleNumber = QtWidgets.QComboBox(self.centralwidget)
        self.comboBoxStyleNumber.setGeometry(QtCore.QRect(500, 90, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.comboBoxStyleNumber.setFont(font)
        self.comboBoxStyleNumber.setCurrentText("")
        self.comboBoxStyleNumber.setObjectName("comboBoxStyleNumber")
